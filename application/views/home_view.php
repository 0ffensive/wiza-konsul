        ...
        <div class="container">
			...
			<div>
				...
				<div>
					...
					<form id="dodawanie-form" method="post" action="<?php echo site_url('welcome/data_form'); ?>">	
						<label for="#nazwisko">Nazwisko</label>
						<input id="nazwisko" type="text" name="nazwisko"><br>
						<?php echo "<div class='error-message'>".form_error('nazwisko')."</div>"; ?>

						<label for="#imie">Imie</label>
						<input id="imie" type="text" name="imie"><br>
						<?php echo "<div class='error-message'>".form_error('imie')."</div>"; ?>

						<label for="#nr-dokumentu">Nr dokumentu</label>
						<input id="nr-dokumentu" type="text" name="nr_dokumentu"><br>
						<?php echo "<div class='error-message'>".form_error('nr_dokumentu')."</div>"; ?>
