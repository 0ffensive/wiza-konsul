			...
			<div class="kontener-dodanie-sprawy">
                <div>
                    ...
                    <form>
                        ...
                        <input disabled type="text" id="nazwisko_w-przegladanie-sprawy" value="Kowalski">
                        <label for="#imie-w-przegladanie-sprawy">Imię</label>
                        <input disabled type="text" id="imie-w-przegladanie-sprawy" value="Jan">
                        <label for="#plec-w-przegladanie-sprawy">Płeć</label>
                        <input disabled type="text" id="plec-w-przegladanie-sprawy" value="Męzczyzna">
                        <label for="#data-urodzenia-przegladanie-sprawy">Data urodzenia</label>
                        <input disabled type="date" id="data-urodzenia-przegladanie-sprawy" value="1970-04-24">
                        <label for="#obywatelstwo-przegladanie-sprawy">Obywatelstwo</label>
                        <input disabled type="text" id="obywatelstwo-przegladanie-sprawy" value="Czeska">
                        <label for="#narodowosc-przegladanie-sprawy">Narodowość</label>
                        <input disabled type="text" id="obywatelstwo-przegladanie-sprawy" value="Polska">
                        <label for="#typ-dokumentu-przegladanie-sprawy">Typ dokumentu</label>
                        <input disabled type="text" id="typ-dokumentu-przegladanie-sprawy" value="Dowód osobisty">
                        <label for="#nr-dokumentu-przegladanie-sprawy">Nr dokumentu</label>
                        <input disabled type="text" id="nr-dokumentu-przegladanie-sprawy" value="RGD2456">        
                    </form>
                    <h2>Adres zamieszkania</h2>
                    <form>
                        <label for="#panstwo-przegladanie-sprawy">Państwo</label>
                        <input disabled type="text" id="panstwo-przegladanie-sprawy" value="Czechy">
                        <label for="#miasto-przegladanie-sprawy">Miasto</label>
                        <input disabled type="text" id="miasto-przegladanie-sprawy" value="Praha">
                        <label for="#kod-przegladanie-sprawy">Kod pocztowy</label>
                        <input disabled type="text" id="kod-przegladanie-sprawy" value="13000">
                        <label for="#ulica-przegladanie-sprawy">Ulica</label>
                        <input disabled type="text" id="ulica-przegladanie-sprawy" value="Mahlerovy sady">
                        <label for="#nr-domu-przegladanie-sprawy">Nr domu</label>
                        <input disabled type="text" id="nr-domu-przegladanie-sprawy" value="1">
                        <label for="#nr-lokalu-przegladanie-sprawy">Nr lokalu</label>
                        <input disabled type="text" id="nr-lokalo-przegladanie-sprawy" value="-">                    
                    </form>
                </div>
                <div>
                    ...
                    <form>
                        ...
                        <input disabled type="text" id="nazwisko-przodka-1-przegladanie-sprawy" value="Kowalska">
                        <label for="#imie-przodka-1-przegladanie-sprawy">Imię</label>
                        <input disabled type="text" id="imie-przodka-1-przegladanie-sprawy" value="Danuta">
                        <label for="#pokrewienstwo-przodka-1-przegladanie-sprawy">Stopień pokrewieństwa</label>
                        <input disabled type="text" id="pokrewienstwo-przodka-1-przegladanie-sprawy" value="Matka"> 
                        <label for="#obywatelstwo-przodka-1-przegladanie-sprawy">Obywatelstwo</label>
                        <input disabled type="text" id="obywatelstwo-przodka-1-przegladanie-sprawy" value="Polskie">
                        <label for="#narodowosc-przodka-1-przegladanie-sprawy">Narodowość</label>
                        <input disabled type="text" id="narodowosc-przodka-1-przegladanie-sprawy" value="Polska">
                        <label for="#typ-dokumentu-przodka-1-przegladanie-sprawy">Typ dokumentu</label>
                        <input disabled type="text" id="typ-dokumentu-przodka-1-przegladanie-sprawy" value="Prawo jazdy">
                        <label for="#nr-dokumentu-przodka-1-przegladanie-sprawy">Nr dokumentu</label>
                        <input disabled type="text" id="nr-dokumentu-przodka-1-przegladanie-sprawy" value="EFG 24353">                   
                    </form>

                    <h2>Dane drugiego przodka</h2>
                    <form>
                        <label for="#nazwisko-przodka-2-przegladanie-sprawy">Nazwisko</label>
                        <input disabled type="text" id="nazwisko-przodka-2-przegladanie-sprawy" value="Kowalski">
                        <label for="#imie-przodka-2-przegladanie-sprawy">Imię</label>
                        <input disabled type="text" id="imie-przodka-2-przegladanie-sprawy" value="Bogdan">
                        <label for="#pokrewienstwo-przodka-2-przegladanie-sprawy">Stopień pokrewieństwa</label>
                        <input disabled type="text" id="pokrewienstwo-przodka-2-przegladanie-sprawy" value="Ojciec">  
                        <label for="#obywatelstwo-przodka-2-przegladanie-sprawy">Obywatelstwo</label>
                        <input disabled type="text" id="obywatelstwo-przodka-2-przegladanie-sprawy" value="Polskie">
                        <label for="#narodowosc-przodka-2-przegladanie-sprawy">Narodowość</label>
                        <input disabled type="text" id="narodowosc-przodka-2-przegladanie-sprawy" value="Polska">
                        <label for="#typ-dokumentu-przodka-2-przegladanie-sprawy">Typ dokumentu</label>
                        <input disabled type="text" id="typ-dokumentu-przodka-2-przegladanie-sprawy" value="Dowód osobisty">
                        <label for="#nr-dokumentu-przodka-2-przegladanie-sprawy">Nr dokumentu</label>
                        <input disabled type="text" id="nr-dokumentu-przodka-2-przegladanie-sprawy" value="EFG 24353">                     
                    </form>
               </div>
            </div>             
